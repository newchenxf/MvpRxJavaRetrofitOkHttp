package net.smartbetter.mvpdemo.transformer;

import net.smartbetter.mvpdemo.base.BaseHttpResult;
import net.smartbetter.mvpdemo.exception.ErrorType;
import net.smartbetter.mvpdemo.exception.ExceptionEngine;
import net.smartbetter.mvpdemo.exception.ServerException;
